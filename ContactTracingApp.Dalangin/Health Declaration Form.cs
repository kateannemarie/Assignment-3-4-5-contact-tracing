...
namespace ContactTracingApp.Dalangin
{
    public partial class Health_Declaration_Form : Form
    {
        ...
        private void generateButton_Click(object sender, EventArgs e)
        {
            ...
            QRCodeData datainfo = qr.CreateQrCode("Date: " + datePicker.Text + "Name: " + nameTextBox2.Text + "Sex: " + Sex + "Age: " + ageTextBox.Text + " years old" + "Contact Address: " + contactaddressTextBox.Text + "Mobile No./Telephone No.: " + contactnumberTextBox2.Text + "Email Address: " + emailaddressTextBox.Text + "Symptoms are: " + Symptoms + nameTextBox2.Text + numberOne + nameTextBox2.Text + numberTwo + nameTextBox2.Text + numberThree + nameTextBox2.Text + "," + numberFour + nameTextBox2.Text + numberFive + nameTextBox2.Text + "," + numberSix, QRCodeGenerator.ECCLevel.Q);
            QRCode code = new QRCode(datainfo);
            showQRPictureBox.Image = code.GetGraphic(5);
        }
    }
}
